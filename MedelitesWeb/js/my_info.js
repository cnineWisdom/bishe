...
function listClick(value){
	if(value == 1){
		$("#crowdfunding_iframe", window.parent.document).attr("src","crowdfunding_center/touhou_manage.html");
	...
	if(value == 3){
		$("#crowdfunding_iframe", window.parent.document).attr("src","crowdfunding_center/identity_prove.html");
		$("#crowdfunding_iframe", window.parent.document).attr("height",1045);
	...
	if(value == 4){
		$("#crowdfunding_iframe", window.parent.document).attr("src","crowdfunding_center/make_password.html");
		$("#crowdfunding_iframe", window.parent.document).attr("height",1045);
		$("#listClick1", window.parent.document).attr("class","");
		$("#listClick3", window.parent.document).attr("class","");
	...
	if(value == 11){
		$("#crowdfunding_iframe", window.parent.document).attr("src","crowdfunding_center/grade_integration.html");
	...
	if(value == 12){
		$("#crowdfunding_iframe", window.parent.document).attr("src","crowdfunding_center/integration_record.html");
		$("#crowdfunding_iframe", window.parent.document).attr("height",1045);
	...
	if(value == 13){
		$("#crowdfunding_iframe", window.parent.document).attr("src","crowdfunding_center/integration_rule.html");
		$("#crowdfunding_iframe", window.parent.document).attr("height",1045);
		$("#listClick11", window.parent.document).attr("class","");
		$("#listClick12", window.parent.document).attr("class","");
	...
	if (value == 9) {
	    $("#crowdfunding_iframe", window.parent.document).attr("src", "crowdfunding_center/investment_inquiry.html");
	    $("#crowdfunding_iframe", window.parent.document).attr("height", 1045);
	    $("#listClick11", window.parent.document).attr("class", "");
	    $("#listClick12", window.parent.document).attr("class", "");
	    $("#listClick13", window.parent.document).attr("class", "menu_list_on");
